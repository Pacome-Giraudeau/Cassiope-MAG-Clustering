...
#SBATCH --mem=100G # mémoire demandée (default: M)
...
#SBATCH --job-name=clingo # nom du job
#SBATCH --mail-user= <mail_address> # email utilisateur: à remplir
#SBATCH --mail-type=FAIL,END #quand envoyer un mail (BEGIN, FAIL, END, ALL)
