...
#SBATCH -c 16 # nombre de coeurs (cpus) 
#SBATCH --mem=150G # mémoire demandée (default: M)
...
#SBATCH -D /env/export/bigtmp2/cassiope/Cassiope-MAG-Clustering # chemin du répertoire de travail
